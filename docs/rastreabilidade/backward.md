...
A seguir na tabela 3, é apresentado as legendas das tabelas 4 e 5.
...
| NFES    | Não Funcional Especificação Suplementar |
...
| Id    | Requisitos                                                                                                                    | Origem | Elos   |
| ----- | ----------------------------------------------------------------------------------------------------------------------------- | ------ | ------ |
| RNF01 | O sistema deve garantir que os dados sejam armazenados e recuperados de forma segura e consistente, sem perda ou corrupção. | NFES   | [ENF01]() |
| RNF02 | O sistema deve responder às solicitações dos usuários de forma rápida e eficiente, sem causar atrasos ou travamentos.    | NFES   | [ENF02]() |
| RNF03 | O sistema deve responder às solicitações dos usuários de forma rápida e eficiente, sem causar atrasos ou travamentos.    | NFES   | [ENF03]() |
