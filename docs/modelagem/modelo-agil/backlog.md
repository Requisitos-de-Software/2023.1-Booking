...
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------- |
| RF01 | o aplicativo deve permitir que os usuários se registrem fornecendo informações básicas, como nome, sobrenome, endereço de e-mail e senha.                                       | [FST01](../../elicitacao/storytelling.md) e FOBS01           |
...
| RF03 | o aplicativo deve permitir que os usuários reservem acomodações selecionadas, inserindo as informações de pagamento e confirmando a reserva.                                    | [FST03](../../elicitacao/storytelling.md), FB03 e FOBS06      |
| RF04 | o aplicativo deve permitir que os usuários cancelem suas reservas de acomodação, desde que sejam feitas dentro dos termos e condições estabelecidos pela empresa.               | [FST04](../../elicitacao/storytelling.md) e FB04             |
...
| RF06 | o aplicativo deve permitir que os usuários reservem voos selecionados, inserindo as informações de pagamento e confirmando a reserva.                                             | [FST06](../../elicitacao/storytelling.md) e FOBS07           |
...
| RF08 | o aplicativo deve permitir que os usuários visualizem seu histórico de reservas anteriores, incluindo informações como datas, acomodações e voos reservados.                   | [FST10](../../elicitacao/storytelling.md), FB05, FB06 e FOBS13 |
...
| RF15 | O sistema deve sugerir hospedagens de acordo com a localização do usuário                                                                                                         | [FB23](../../elicitacao/brainstorm.md) e FOBS04              |
...
| RF18 | O sistema deve ter um sistema de pontuação ligada ao usuário                                                                                                                      | [FB26](../../elicitacao/brainstorm.md) e FOBS03              |
...
| RF21 | O usuário deve poder avaliar e comentar reservas                                                                                                                                    | [FB28](../../elicitacao/brainstorm.md) e FST09               |
| RF22 | Deve ser possível filtrar as pesquisas.                                                                                                                                             | [FOBS05](../../elicitacao/observacao.md) e FB30              |
| RF23 | Deve ser possível alugar carros.                                                                                                                                                    | [FOBS08](../../elicitacao/observacao.md)                       |
| RF24 | O aplicativo deve ter mapa interativo.                                                                                                                                               | [FOBS10](../../elicitacao/observacao.md) e FB14              |
| RF25 | O aplicativo deve ter uma aba de favoritos.                                                                                                                                          | [FOBS12](../../elicitacao/observacao.md) e FB10              |
...
| RF33 | O sistema deve possuir uma carteira digital                                                                                                                                          | [FB15](../../elicitacao/brainstorm.md) e FOBS16              |
...
| RF38 | O sistema deve notificar sobre ofertas                                                                                                                                               | [FB29](../../elicitacao/brainstorm.md) e FOBS018             |
