...
A tabela a seguir, Tabela 21, apresenta todos os artefatos criados no projeto, organizados por etapa, juntamente com seus respectivos autores e revisores.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td></td>
      <td><a href="/modelagem/modelo-agil/nfrFramework">NFR Framework</a></td>
    ...
    <tr>
      <td></td>
      <td><a href="/verificacaoGrupo/priorizacao/moscow">MoSCoW</a></td>
      <td>Pedro e Samuel</td>
      <td></td>
    </tr>
    <tr>
...
<div style="text-align: center">
<p> Tabela 21: Listagem de todos os artefatos com as etapas do projeto, autor(es) e revisor(es). (Fonte: Pedro, 2023). </p>
</div>
